...
data class DsolTimeRef(
	...
	companion object {
		...
		@JvmStatic
		fun of(value: ComparableQuantity<Time>): DsolTimeRef = DsolTimeRef(value)

		@JvmStatic
		fun of(value: Quantity<Time>): DsolTimeRef = of(value.toQuantity())

		@JvmStatic
		fun of(value: Number, unit: Unit<Time>): DsolTimeRef = of(value.toQuantity(unit))

		@JvmStatic
		fun of(value: Number, unit: TimeUnit): DsolTimeRef = of(value.toQuantity(unit))

		@JvmStatic
		fun of(value: Number, unit: TemporalUnit): DsolTimeRef = of(value.toQuantity(unit))
		...
		@JvmStatic
		fun of(value: Instant, epoch: Instant = Instant.EPOCH): DsolTimeRef = of(Duration.between(epoch, value))
