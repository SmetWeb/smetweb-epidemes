...
import io.smetweb.persist.UuidNameRefEntity
...
//@AutoConfigureTestDatabase(replace=Replace.NONE) // default is in-memory
//@Transactional(propagation = Propagation.NOT_SUPPORTED) // default is rollback all
